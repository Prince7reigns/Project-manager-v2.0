  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ❗ FIXED: moved Progress OUTSIDE <p> */}
        <div className="mt-2">
          <p className="text-[13px] text-gray-700/80">
            Task Done:{" "}
            <span className="font-semibold text-gray-700">
              {console.log(todoChecklist?.length,completedTodoCount)}
              {todoChecklist.filter(item => item.completed).length}/{todoChecklist?.length || 0}
            </span>
          </p>
