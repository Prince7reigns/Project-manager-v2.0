...
const ViewTaksDetails = () => {
  ...
  // FIXED: function accepts status argument
  ...
  // 🔥 FRONTEND UPDATE FIX HERE – NO MORE DISAPPEARING CARD
  const updateTodoDetailsByID = async (index) => {
              ...
              <div className="mt-2">
                ...
                {task?.todoChecklist?.map((item, index) => (
                  <TodoChecklist
                    ...
                    onChange={() => updateTodoDetailsByID(index)}
                  />
                ))}
              </div>
